...
<html lang="en">
   <head>
      ...
      <title>KietOn - Lets KIET On...</title>
      ...
      <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
         <div class="container">
            ...
            <div class="navbar-header page-scroll">
               ...
               <a class="navbar-brand" href="#page-top"> KietOn </a>
         ...
         <div class="container">
            <div id="login_signup" class="row">
               <div class="col-lg-12 text-center">
                  <h3 style="color:#03a9f4;">Welcome to the world of Kiet</h3>
                  <br>
                  <?php
                     ...
                     echo('<p class="login" align= "center"><br><br>You are logged in as <strong> ' . $_SESSION['id_proof'] . '</strong>.<br>Go to your home page: <a href="timeline/kieton.php" style="cursor:pointer">Home</a><br><br>You can also logout here: <a href="logout.php" style="cursor:pointer">LogOut</a></p>');
                     }
									...
									if($password1 == $password2){
										...
										if(mysqli_num_rows($data) == 0){
											...
											if(!empty($user_id)) {
												...
												$user_hm_id = $user_id;
												$message = 'Joined KietOn on <br><br>'.$now1;
												$image = '';
												$video = '';
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 text-center">
                  ...
                  <h3 class="section-subheading text-muted">KietOn provides following services</h3>
               </div>
            </div>
            <div class="row text-center">
               ...
               <div class="col-md-4">
                  ...
                  <h4 class="service-heading">Startups</h4>
                  <p class="text-muted"></p>
               </div>
            </div>
         </div>
                  ...
                  <ul class="timeline">
                     ...
                     <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                           ...
                           <div class="timeline-body">
                              <p class="text-muted">I got the concept of KietOn, which can help people to live life easier.</p>
                           </div>
                        </div>
                     </li>
                     <li>
                        ...
                        <div class="timeline-panel">
                           ...
                           <div class="timeline-body">
                              <p class="text-muted">I started developing KietOn website from a simple signup and login page.</p>
                           </div>
                        </div>
                     </li>
                     <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                           ...
                           <div class="timeline-body">
                              <p class="text-muted">I started creating multiple tables in KietOn database, for storing the informations.</p>
                           </div>
                        </div>
                     </li>
					 <li>
                        ...
                        <div class="timeline-panel">
                           ...
                           <div class="timeline-body">
                              <p class="text-muted">I developed KietOn personal home page and chat section for the connectivity of the users.</p>
                           </div>
                        </div>
                     </li>
                     <li class="timeline-inverted">
         ...
         <div class="footer-above">
            <div class="container">
               <div class="row">
                  ...
                  <div class="footer-col col-md-4">
                     <h3>About KietOn</h3>
                     <p>KietOn is a free to use, open source of help for all.</p>
                  </div>
               </div>
            </div>
         </div>
